...
```{r}
 с1_1 <- y2.political[political_clusters$cluster==1,] %>%
...
c2_1 <- y2.political[political_clusters$cluster==2,] %>%
  ggplot(aes(x = "", fill = factor(zelensk))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
...
c3_1 <- y2.political[political_clusters$cluster==3,] %>%
  ggplot(aes(x = "", fill = factor(zelensk))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
c4_1 <- y2.political[political_clusters$cluster==4,] %>%
  ggplot(aes(x = "", fill = factor(zelensk))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0)
grid.arrange(с1_1, c2_1, c3_1, c4_1, nrow=2, top="Zelenskiy?")
```
...
```{r}
 с1_2 <- y2.political[political_clusters$cluster==1,] %>%
...
с2_2 <- y2.political[political_clusters$cluster==2,] %>%
  ggplot(aes(x = "", fill = factor(r_u_same))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
 ...
 с3_2 <- y2.political[political_clusters$cluster==3,] %>%
  ggplot(aes(x = "", fill = factor(r_u_same))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
 с4_2 <- y2.political[political_clusters$cluster==4,] %>%
  ggplot(aes(x = "", fill = factor(r_u_same))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
grid.arrange(с1_2,  с2_2, с3_2, с4_2, nrow=2, top="Does Russians and Ukrainians form one nation?")
```
...
```{r}
с1_3 <- y2.political[political_clusters$cluster==1,] %>%
...
с2_3 <- y2.political[political_clusters$cluster==2,] %>%
  ggplot(aes(x = "", fill = factor(gas_cheap))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
 ...
 с3_3 <- y2.political[political_clusters$cluster==3,] %>%
  ggplot(aes(x = "", fill = factor(gas_cheap))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
 с4_3 <- y2.political[political_clusters$cluster==4,] %>%
  ggplot(aes(x = "", fill = factor(gas_cheap))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
grid.arrange(с1_3,  с2_3, с3_3, с4_3, nrow=2, top="Some cheap gas?")
```
...
```{r}
с1_4 <- y2.political[political_clusters$cluster==1,] %>%
...
с2_4 <- y2.political[political_clusters$cluster==2,] %>%
  ggplot(aes(x = "", fill = factor(gov_all))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
 ...
 с3_4 <- y2.political[political_clusters$cluster==3,] %>%
  ggplot(aes(x = "", fill = factor(gov_all))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
 с4_4 <- y2.political[political_clusters$cluster==4,] %>%
  ggplot(aes(x = "", fill = factor(gov_all))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
grid.arrange(с1_4,  с2_4, с3_4, с4_4, nrow=2, top="All desires of the public?")
```
...
```{r}
с1_5 <- y2.political[political_clusters$cluster==1,] %>%
...
с2_5 <- y2.political[political_clusters$cluster==2,] %>%
  ggplot(aes(x = "", fill = factor(abroad_west))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
 ...
 с3_5 <- y2.political[political_clusters$cluster==3,] %>%
  ggplot(aes(x = "", fill = factor(abroad_west))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
 с4_5 <- y2.political[political_clusters$cluster==4,] %>%
  ggplot(aes(x = "", fill = factor(abroad_west))) + 
  geom_bar(width = 1) +
  theme(axis.line = element_blank(), 
        plot.title = element_text(hjust=0.5)) + 
  labs(fill="class", 
       ...
       y=NULL, 
       title="") + coord_polar(theta = "y", start=0) 
grid.arrange(с1_5,  с2_5, с3_5, с4_5, nrow=2, top="Travelling to the Europe?")
```
<br/>**Fact4:  The biggest fraction of people who travel to the Europe is in the fourth cluster, the smallest is in the first one**</>
